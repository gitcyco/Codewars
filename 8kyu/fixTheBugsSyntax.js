...
// 
// Extension: Once you have fixed all the syntax errors present in the code (basic requirement), you may 
// attempt to optimise the code or try a different approach by coding it from scratch.
//
// Answer:
