// 6 kyu Parity bit - Error detecting code
//
...
// Parity bits are used as the simplest form of error detecting code, and can detect a 1 bit error.
// 
...
// Answer:
const parityBit = b => 
  b.split(' ').map (e => e.substring(0,7).split('')
   .filter(i=>i==1).length % 2 == e[7] ? e.substring(0,7) : 'error').join(' ');