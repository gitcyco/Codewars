...
// Each key will have a 3 chars string to represent the permission, for example the string rw- say that the user
// want the permission read, write without the execute. If a key is missing set the permission to ---
//
...
const getVal = (id, perm, vals) =>
  perm[id] != undefined ? perm[id].split("").reduce((acc, e) => (acc += vals[e]), 0) : 0;
