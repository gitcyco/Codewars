...
// Each entry in the list corresponds to one vote for this name. You do not know the names in advance (because there are no candidates).
//
...
function getWinner(listOfBallots) {
  let obj = listOfBallots.reduce((a, e) => (e in a ? a[e]++ : (a[e] = 1), a), {});
  let arr = Object.entries(obj).sort((a, b) => b[1] - a[1]);
  if (arr[0][1] > listOfBallots.length / 2) {
