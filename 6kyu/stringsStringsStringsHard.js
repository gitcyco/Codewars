...
//
// After you recovered toString() for booleans, numbers and numerical arrays last time, you now realise
// that because , you have to be able to convert complex arrays containing any and all data types into strings too!
// Task
//
...
//
// Notice that in this version of "Strings, strings, strings", you are not allowed to leave spaces between elements in an array.
// If you leave any spaces you will fail the test.
...
//
// Please note that while unnecessary whitespace will not be accepted, whitespace that already exists
// in strings must be preserved; that is, "Hello World" should NOT be converted into "HelloWorld".
