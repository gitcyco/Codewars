...
//
// Javascript functions can be combined to form new functions. For example the functions addOne and multTwo
// can be combined to form a new function which first adds one and then multiplies by two, as follows:
//
// const addOne = (a) => a + 1
// const multTwo = (b) => b * 2
...
//
// Combining functions like this is called function composition. Functional programming libraries in Javascript
// such as Ramda include a generic compose function which does the heavy lifting of combining functions for you. So you could implement addOneMultTwo as follows:
//
