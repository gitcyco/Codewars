...
//     Age is represented by a number which can be any positive integer up to 19
//
// Answer:
function isAgeDiverse(list) {
    const dec = Array(10).fill(0);
    list.forEach(e => e.age > 99 ? dec[9]++ : dec[parseInt((+e.age / 100) * 10) - 1]++)
    return !dec.some(e => e === 0);
}