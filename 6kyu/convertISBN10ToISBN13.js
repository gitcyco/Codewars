// 6 kyu Convert ISBN-10 to ISBN-13
//
// Task
//
...
// You can convert a 10-digit ISBN to a 13-digit ISBN by adding the prefix number (978) to the beginning and then recalculating
// the last, check digit using a fairly simple method.
// Method
//
...
function isbnConverter(isbn) {
  ...
  let chk =
    isbn
      .replace(/-/g, "")
      .split("")
      .reduce((ac, e, i) => (ac += i % 2 ? e * 3 : e * 1), 0) % 10;
  chk = chk !== 0 ? 10 - chk : 0;
  return isbn + chk;
}
