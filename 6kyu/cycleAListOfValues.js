...
//
// According to the wireframes delivered to you in PowerPoint format the user should be able
// to cycle through specified zoom levels by clicking a button in the UI repeatedly.
// The reverse direction should work with shift key held.
//
...
function cycle(dir, arr, cur) {
  ...
  return arr[(((start + dir) % len) + len) % len];
}
