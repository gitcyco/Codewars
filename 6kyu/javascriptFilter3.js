...
// 
// He is only interested in e-mailing the users and ask them to sign up again, so no need to keep 
// the user-name, only e-mail addresses for the user-names that start or end with a "." should be returned. 
...
// The second argument gives the index you're looking at and the third argument is the array itself:
//
// Answer:
