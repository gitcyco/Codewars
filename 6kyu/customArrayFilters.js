...
Array.prototype.even = function () {
  return this.filter((e) => parseInt(e) === e && +e !== 0).filter((e) => !(+e % 2));
};

Array.prototype.odd = function () {
  return this.filter((e) => parseInt(e) === e).filter((e) => +e % 2);
};

Array.prototype.under = function (x) {
  return this.filter((e) => parseInt(e) === e).filter((e) => +e < x);
};
...
Array.prototype.inRange = function (min, max) {
  return this.filter((e) => parseInt(e) === e).filter((e) => +e >= min && +e <= max);
};
