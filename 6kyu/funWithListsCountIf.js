...
//
// Implement the method countIf (count_if in PHP and Python), which accepts a linked list (head) and a predicate 
// function, and returns the number of elements which apply to the given predicate.
// 
