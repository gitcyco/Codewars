...
// here is precisely the same (to square every digit in the given number), in 36 or fewer characters (JavaScript), or 47 or fewer in Ruby
//
...
//
// Answer:
// (autoformatter changed the spacing, this is 34 chars without spaces)
sd = (n) => +("" + n).replace(/./g, (e) => e * e);
