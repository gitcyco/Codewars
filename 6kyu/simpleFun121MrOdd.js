...
//
// In this valentine when he went to meet his girlfriend. But he forgot to take gift.
// Because of this he told his gf that he did an odd thing. His gf became angry and gave him punishment.
//
...
function odd(str) {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    if (str[i] === "d" && odd.length > 0) {
      if (odd[ptr] < 3 && odd[ptr] > 0) odd[ptr]++;
      if (odd[ptr] === 3) ptr++;
    }
  }
  return odd.filter((e) => e === 3).length;
}
