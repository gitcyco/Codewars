...
//
// You will receive an array of strings. All of them are supposed to be the same as the original but, unfortunately, they were
...
function assembleString(arr) {
  let str = arr && arr.length > 0 ? arr[0] : "";
  return str.replace(/\*/g, (e, i) => {
    let a = arr.find((v) => v[i] !== "*");
    return a ? a[i] : "#";
  });
}
