...
// Description
//
// A single IP address with subnet mask actually specifies several addresses: a network block, and a host identifier, and a broadcast address.
// These addresses can be calculated using a bitwise AND operation on each bit.
//
...
// bitwise AND
//
// To calculate the network block and host identifier the bits in each octet are ANDed together.
// When the result of the AND operation is '1', the bit specifies a network address (instead of a host address).
//
