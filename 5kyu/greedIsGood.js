...
//  One   5   =>   50 point
//
// A single die can only be counted once in each roll. For example, a given "5" can only count
// as part of a triplet (contributing to the 500 points) or as a single 50 points, but not both in the same roll.
//
// Example scoring
//
//  Throw       Score
...
// Answer:
function score(dice) {
  const counts = dice.reduce((a, e) => (a[e - 1]++, a), new Array(6).fill(0));
