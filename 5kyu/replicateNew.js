...
// Aside: Operators?
//
// In JavaScript, perhaps no operator is as complicated as new.
// "Wait; new is an operator?" Yep; an operator is something that operates on one or more operands and evaluates to a result.
...
// parameter (the constructor), plus an unknown number of additional parameters of any type (arguments for the constructor).
// When invoked, nouveau should do everything new does and return the same object new would evaluate to, as specified above.
//
// var john = nouveau(Person, 'John', 30); // same result as above
//
// Answer:
function nouveau(Constructor, ...args) {
  const o = Object.setPrototypeOf({}, Constructor.prototype);
  const obj = Constructor.call(o, ...args);
