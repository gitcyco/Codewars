// 7 kyu Binary to string
//
// Your computer has forgotten how to speak ASCII! (or Unicode, whatever) It can only communicate in binary, and it has something
// important to tell you. Write a function which will receive a long string of binary code and convert it to a string.
...
const binaryToString = (bin) =>
  bin
    .split("0b")
    .map((e) => e && String.fromCharCode("0b" + e))
    .join("");
