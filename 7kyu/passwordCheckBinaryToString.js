// 7 kyu Password Check - Binary to String
//
...
// Convert the binary to a string and compare to the password array. If the password is found, return the password string, else return false;
//
...
function decodePass(passArr, bin) {
  const str = bin
    ...
    .join("");
  return passArr.includes(str) ? str : false;
}
