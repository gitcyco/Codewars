...
// architect, comes up with a plan to remove the most boring exhibitions. 
...
// asks you to write a program that tells her the ratings of the items after one removed the lowest one. Fair enough.
// Task
// 
...
function removeSmallest(numbers) {
    ...
    const num = [...numbers];
    let lowest = [...num].sort((a,b) => +a- +b)[0];
    num.splice(num.indexOf(lowest), 1);
    return num;
}