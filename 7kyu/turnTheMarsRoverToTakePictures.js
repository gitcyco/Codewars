// 7 kyu Turn the Mars rover to take pictures
//
...
// 
// Mars rover can face 4 different directions, that would be N, S, E, W. Every time it needs to turn it will 
// call a command turn passing the current position it is facing and the position it wants to face.
// 
// For example:
// 
...
// Answer:
const turn = (c, t) => "NWSEN".includes(c + t) ? 'left' : 'right';