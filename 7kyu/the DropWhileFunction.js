...
// We'll call this the dropWhile function. It accepts two arguments. The first is the sequence of values, and the second is the predicate function.
...
//
// Answer:
const dropWhile = (arr, pred) => span(arr, pred)[1];

const span = (arr, predicate) =>
  !arr.length ? [[], []] : (a = arr.findIndex((e) => !predicate(e))) >= 0 ? [arr.slice(0, a), arr.slice(a)] : [arr, []];
